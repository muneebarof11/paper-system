...
@section('content')
    <div class="container">
        <form class="row needs-validation" novalidate action="{{route('App.User.Update', $data)}}" method="POST" enctype="multipart/form-data">
            ...
            <section class="col-lg-12 col-sm-12">
                ...
                <div class="form-group row">
                    ...
                    <input type="text" class="form-control" id="instPhone1" name="email" required  value="{{$data->email}}">
                    <div class="invalid-feedback">Email is required</div>
                </div>
                <div class="form-group row">
                    <label class="col-sm-12 col-form-label" for="instPhone2">Username</label>
                    <input type="text" class="form-control" id="instPhone2" name="username" disabled value="{{$data->username}}">
                    <div class="invalid-feedback">Username is required</div>
                </div>
                <div class="form-group row">
                    <label class="col-sm-12 col-form-label" for="instPhone2">Password</label>
                    <input type="password" class="form-control no-validate" id="instPhone2" name="password">
                ...
                <div class="form-group row">
                    ...
                    <select class="form-control no-validate" id="role" name="role">
                        ...
                        @endif
                        @if(\App\Helper::checkUserRole('admin', false))
                            <option value="admin" {!! $data->role == 'admin' ? 'selected' : '' !!}>Admin</option>
                            <option value="teacher" {!! $data->role == 'teacher' ? 'selected' : '' !!}>Teacher</option>
                        @endif
                    </select>
