...
@section('content')
    <div class="container">
        <form class="row needs-validation" novalidate action="{{ route('App.User.Update', $data) }}" method="POST"
            ...
            <section class="col-lg-12 col-sm-12">
                ...
                <div class="form-group row">
                    ...
                    <input type="text" class="form-control" id="instPhone2" name="username" disabled
                        value="{{ $data->username }}">
