...
@section('content')
    <div class="container">
        <form class="row needs-validation" novalidate action="{{route('App.store')}}" method="POST" enctype="multipart/form-data">
            ...
            <section class="col-lg-6 col-sm-12">
                ...
                <div class="form-group row">
                    ...
                    <textarea class="form-control" id="instAddress1" rows="3" name="address1" required></textarea>
                    <div class="invalid-feedback">Address is required</div>
                </div>

                <div class="form-group row">
                    <label class="col-sm-12 col-form-label" for="instAddress2">Address 2 (optional)</label>
                    <textarea class="form-control no-validate" id="instAddress1" rows="3" name="address2"></textarea>
                </div>
            ...
            <section class="col-lg-6 col-sm-12">
                <div class="form-group">
                    ...
                    <div class="custom-file">
                        <input type="file" class="custom-file-input" id="primaryLogo" name="logo" required>
