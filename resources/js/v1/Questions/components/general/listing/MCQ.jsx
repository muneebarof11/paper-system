    ...
    render() {
        ...
        return (
            ...
            <div className="mt-4 mb-4 row pb-4 pt-2">
                            ...
                            q.en.options.map((o, i) => {
                                return (
                                    <div
                                        ...
                                        className={`option-${this.props.question.id}-${i} ${q.en.correct_answer == $helper.getAlphabet(i) ? 'correct-answer' : ''} question-option col-lg-6`}>
                ...
                <div className={`col-lg-5 urdu-font text-right ${q.rtl.statement.length > 0 ? '' : 'd-none' }`}>
