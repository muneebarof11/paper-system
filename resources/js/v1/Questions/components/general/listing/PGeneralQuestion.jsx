...
class PGeneralQuestion extends Component {
    ...
    render() {
        ...
        return (
            <React.Fragment>
                <div className={`mt-2 ${!this.validateBlankLineValue() ? 'mb-2' : ''} col-sm-12 px-0 py-2 row mx-0 ${q.checked ? 'selected_question' : ''} question_row`} onClick={this.updateSelectedQuestions}>
                    ...
                    <div className={`urdu-font text-right col-sm-6`}>
...
export default connect(mapStateToProps, mapDispatchToProps)(PGeneralQuestion);
