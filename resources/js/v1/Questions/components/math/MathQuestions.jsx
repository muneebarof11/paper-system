...
class MathQuestions extends PureComponent {
    ...
    renderQuestions(data, component) {
        if (typeof this.props.questions[data.name] === typeof undefined) return <React.Fragment />
        if (typeof this.props.questions[data.name].data === typeof undefined) return <React.Fragment />

        return this.props.questions[data.name].data.length > 0
            ? this.props.questions[data.name].data.map((question, index) => {
                // Correct! JSX type can be a capitalized variable.
                if(component === 'image') return <React.Fragment />;
                const SpecificComponent = components[component];
                return <SpecificComponent question={question} number={index + 1} type={data.name} medium={this.props.subject.medium} />;
            })
...
export default connect(mapStateToProps, mapDispatchToProps)(MathQuestions);
