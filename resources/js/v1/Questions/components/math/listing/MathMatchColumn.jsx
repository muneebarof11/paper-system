...
class MathMatchColumn extends Component {
        ...
        return (
            <div className="mt-4 mb-4 row pb-4 pt-2">
                <div className="col-lg-10">
                    <h5 className="mb-2">{number}) <MathJax math={q.en.statement} /></h5>
                    <table className="table-bordered col-lg-6">
                        ...
                        {q.en.columns.length > 0 ?
                            q.en.columns.map((c, i) => {
                                return (
                                    <tr>
                                        <td className="py-2 pl-2"><MathJax math={c.A} /></td>
                                        <td className="py-2 pl-2"><MathJax math={c.B} /></td>
                                    </tr>
                                )
                            })
...
export default connect(mapStateToProps, mapDispatchToProps)(MathMatchColumn);
