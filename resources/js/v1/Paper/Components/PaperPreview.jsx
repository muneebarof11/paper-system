...
const PMCQ = lazy(() =>
    import("../../Questions/components/general/listing/PMCQ")
);
const PGeneralQuestion = lazy(() =>
    import("../../Questions/components/general/listing/PGeneralQuestion")
);
const PRTLMCQ = lazy(() =>
    import("../../Questions/components/urdu/listing/PRTLMCQ")
);
const PRTLGeneralQuestion = lazy(() =>
    import("../../Questions/components/urdu/listing/PRTLGeneralQuestion")
);
const PISLGeneralQuestion = lazy(() =>
    import("../../Questions/components/islamiyat/listing/PISLGeneralQuestion")
);
const PMatchColumn = lazy(() =>
    import("../../Questions/components/general/listing/PMatchColumn")
);
const PImageQuestion = lazy(() =>
    import("../../Questions/components/general/listing/PImageQuestion")
);
const PMathMCQ = lazy(() =>
    import("../../Questions/components/math/listing/PMathMCQ")
);
const PMathGeneralQuestion = lazy(() =>
    import("../../Questions/components/math/listing/PMathGeneralQuestion")
);
const PEngMCQ = lazy(() =>
    import("../../Questions/components/english/listing/PEngMCQ")
);
...
class PaperPreview extends PureComponent {
    ...
    updatePaperOption(key, value, shouldExecute) {
        ...
        obj[key] = value;
        this.setState(obj);
        if (shouldExecute !== false) this.updatePaperSetting(key, value);
    }
    ...
    updateQuestionStatement(question, value) {
        console.log(question, value, "updateQuestionStatement");
    }
        ...
        return (
            <React.Fragment>
                <section className="paper-preview">
                    {preview_only === null ? (
                        <div className="container-fluid paper-settings mb-3 pt-3 border-bottom bg-dark">
                            <h3
                            ...
                            <div className="row mx-0">
                                ...
                                <div className="form-group col-lg-2 mb-0">
                                    <label
                                        className="col-sm-12 col-form-label px-0"
                                        htmlFor="headerStyle"
                                    >
                                        Header Style
                                    </label>
                                ...
                                <div className="form-group col-lg-2  mb-0">
                                    ...
                                    <input
                                        ...
                                        name="heading_size"
                                        value={this.props.info.questionFontSize}
                                        id="heading_size"
                                        onChange={e =>
                                            this.props.updatePaperSetting(
                                                "questionFontSize",
                                ...
                                <div className="form-group col-lg-2 mb-0">
                                    ...
                                    <input
                                        ...
                                        className="form-control"
                                        name="options_size"
                                        value={this.props.info.optionFontSize}
                                        id="options_size"
                                        onChange={e =>
                                            this.props.updatePaperSetting(
                                                "optionFontSize",
                                ...
                                <div className="form-group col-lg-2 mb-0">
                                    ...
                                    <input
                                        ...
                                        className="form-control"
                                        name="blank_lines"
                                        value={this.props.info.blank_lines}
                                        id="blank_lines"
                                        onChange={e =>
                                            this.props.updatePaperSetting(
                                                "blank_lines",
                            ...
                            <div className="row mx-0">
                                <div className="form-group col-lg-3">
                                    ...
                                    <button
                                        className="btn btn-danger col-lg-12 px-0"
                                        onClick={this.backAndEdit}
                                    >
                                        Back / Edit
                                    </button>
                                </div>
                                ...
                                <div className="form-group col-lg-3">
                                    ...
                                    <button
                                        className="btn btn-warning col-lg-12 px-0"
                                        data-toggle="modal"
                                ...
                                <div className="form-group col-lg-3">
                                    <div className="col-lg-12 px-0 mx-0 row">
                                        <div className="col-sm-6 pl-0">
                                            ...
                                            <button
                                                className="btn btn-primary col-lg-12 px-0"
                    ...
                    <section ref={ref} className="container">
                        ...
                        <div className="container-fluid rendered-paper-questions mt-4 pb-3 px-0">
                            <img
                                ...
                                src={`${$helper.getImageBasePath()}${
                                    this.state.institute.logo
                                }`}
                                alt=""
                            />
                ...
                <ImportModal>
                    <h3>
                        Answers Key
                        <button
                            className="no-print float-right btn btn-primary"
                            onClick={() => window.print()}
                        >
                            Print
                        </button>
    ...
    renderAnswerKey() {
        let toRender = [];
        if (this.props.answerKey.length <= 0) return [];

        for (let i in this.props.answerKey) {
            toRender.push(
                <h4 className="mb-0 mt-3">Question: {parseInt(i) + 1}</h4>
            );
            toRender.push(
                <div className="row col-sm-12">
                    {this.answers(this.props.answerKey[i].answers)}
                </div>
            );
        }
    ...
    renderConfirmedQuestions() {
        return this.props.questions.map((obj, i) => {
            ...
            } else if (this.props.info.medium === "urdu") {
                c = rtl_components[obj.form_type];
            } else {
                    ...
                    obj.questions.map((q, j) => {
                        return (
                            <SpecificComponent
                                ...
                                only_display
                                type={obj.form_type}
                                questionFontSize={this.ptToRem(
                                    this.props.info.questionFontSize
                                )}
                                optionsFontSize={this.ptToRem(
                                    this.props.info.optionFontSize
                                )}
                                blank_lines={this.props.info.blank_lines}
                                updateQuestionStatement={
                                    this.updateQuestionStatement
                                }
                            />
                        );
                    })
            ...
            const displayed_questions = (
                <section
                    className={`${obj.form_type}-question-section ${table_mcq_class} displayed-questions col-sm-12 px-0`}
                >
                    {questions}
                </section>
            );
    ...
    generateTitle2(obj, i) {
        ...
        return (
            <div className="question_title_row pt-3 col-sm-12 row px-0 mx-0">
                <div
                    className={`${
                        !d_rtl_question_title ? "col-sm-8" : "col-sm-4"
                    } ${!d_eng_question_title ? "d-none" : ""}`}
                >
                    <h4
                        style={{
                            fontSize: this.ptToRem(
                                this.props.info.questionFontSize
                            ),
                            fontWeight: "bold"
                        }}
                ...
                <div
                    className={`urdu-font text-right ${
                        !d_eng_question_title ? "col-sm-8" : "col-sm-4"
...
const mapDispatchToProps = dispatch => {
    return {
        ...
        fetchAnswerKey: formData =>
            dispatch(fetchAnswerKey(dispatch, formData)),
        ...
        updatePaperSetting: (key, value) =>
            dispatch(updatePaperSetting(dispatch, key, value))
    };
};
